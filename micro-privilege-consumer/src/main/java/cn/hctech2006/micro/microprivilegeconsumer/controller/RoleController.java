...
import cn.hctech2006.micro.microprivilegeconsumer.service.SysRoleService;
...
//            @ApiImplicitParam(type = "query",name = "menus", value = "菜单编号列表",paramType = "body",dataType = "java.util.List")
    ...
    @CrossOrigin(origins = "*", allowCredentials = "true",allowedHeaders = "*",methods = {RequestMethod.GET, RequestMethod.DELETE, RequestMethod.HEAD, RequestMethod.OPTIONS, RequestMethod.PUT, RequestMethod.POST, RequestMethod.PATCH})
    public HttpResult findAll(String name, Byte delFlag){
        return sysRoleService.findAll(name, delFlag);
    }
}
